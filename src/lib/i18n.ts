...
const es = {
  ...
  register: {
    ...
    roleSubtitle: 'Elige cómo participarás en la plataforma',
    participant: 'Participante',
    participantDesc: 'Completa encuestas y contribuye con datos',
    researcher: 'Investigador',
    researcherDesc: 'Crea encuestas y analiza resultados',
    role: 'Rol',
  ...
  profile: {
    ...
    deleteConfirm: '¿Estás seguro de eliminar tu cuenta?',
    deleteWarning: 'Esta acción es irreversible. Todos tus datos, respuestas y perfil serán eliminados permanentemente.',
    deleteCancel: 'Cancelar',
    deleteConfirmButton: 'Sí, eliminar cuenta',
    deletedTitle: 'Cuenta eliminada',
    deletedDesc: 'Tu cuenta ha sido eliminada exitosamente.',
  ...
  createSurvey: {
    ...
    subtitle: 'Diseña una nueva encuesta para los participantes',
    basicInfo: 'Información básica',
    titleLabel: 'Título',
    titlePlaceholder: 'Ej: Gasto en transporte público',
    descLabel: 'Descripción',
    descPlaceholder: 'Explica el propósito de la encuesta...',
    categoryLabel: 'Categoría',
    minutesLabel: 'Minutos estimados',
    incentiveLabel: 'Incentivo (opcional)',
    incentivePlaceholder: 'Ej: Sorteo de $50 USD entre participantes',
    questions: 'Preguntas',
    ...
    missingTitle: 'Escribe un título para la encuesta',
    missingQuestions: 'Agrega al menos una pregunta',
...
const en: typeof es = {
  ...
  register: {
    ...
    roleSubtitle: 'Choose how you will participate in the platform',
    participant: 'Participant',
    participantDesc: 'Complete surveys and contribute data',
    researcher: 'Researcher',
    researcherDesc: 'Create surveys and analyze results',
    role: 'Role',
  ...
  profile: {
    ...
    deleteWarning: 'This action is irreversible. All your data, responses, and profile will be permanently deleted.',
    deleteCancel: 'Cancel',
    deleteConfirmButton: 'Yes, delete account',
    deletedTitle: 'Account deleted',
    deletedDesc: 'Your account has been successfully deleted.',
  ...
  createSurvey: {
    title: 'Create survey',
    subtitle: 'Design a new survey for participants',
    basicInfo: 'Basic information',
    titleLabel: 'Title',
    titlePlaceholder: 'E.g. Public transportation spending',
    descLabel: 'Description',
    descPlaceholder: 'Explain the purpose of the survey...',
    categoryLabel: 'Category',
    minutesLabel: 'Estimated minutes',
    incentiveLabel: 'Incentive (optional)',
    incentivePlaceholder: 'E.g. $50 USD raffle among participants',
    questions: 'Questions',
    ...
    missingTitle: 'Enter a title for the survey',
    missingQuestions: 'Add at least one question',
    success: 'Survey published successfully',
    error: 'Error publishing survey',
  },
  common: {
    tryAgain: 'Try again',
  },
